...
from app.serializers.user import UserBaseSchema, CreateUserResponseModel, UpdateUserResponseModel
...
def test_failed_create(app_url):
    response = httpx.patch(f'{app_url}/users', json=new_user)
